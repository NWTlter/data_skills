...
A DOI is a globally unique and persistent identifier that unambiguously resolves to the data package [landing page](#0). DOIs are used in citations and references of a data package.
