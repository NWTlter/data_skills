...
It is challenging for humans to read EML directly. However the landing page of each dataset on EDI has the salient parts displayed in an easy-to-read format. Toggling the full metadata button will display/collapse details
...
Any time you download a dataset you will want to make note of the suggested dataset citation, so you can track what you are using and credit the authors appropriately. EDI provides a handy button to do just this. ![](figures/citation.jpg){width="50%"}
