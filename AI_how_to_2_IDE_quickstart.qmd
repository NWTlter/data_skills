...
## Leveling up: using AI within your IDE
...
#### Models 
-  To conserve tokens start with the free tier models and work your way up to more expensive models if things aren't working. Current consensus is that Claude code is the best for R coding; there is a [blog](https://www.simonpcouch.com/blog/) that fairly regularly does a bake-off, so check back there if you want the most current
...
or Highlight an existing code and use the Copilot 'Code Review' function.
...
Features are similar in Rstudio and VS code. 
